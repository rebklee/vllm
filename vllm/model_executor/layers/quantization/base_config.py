...
class QuantizationConfig(ABC):
    ...
    def __init__(self):
        ...
        self.online_quantization_config: Any = None
    ...
    def get_effective_quant_method(
        ...
        Online quantization is applied only when the checkpoint left the layer
        unquantized. Overlaying a layer that is already quantized raises.
        """
