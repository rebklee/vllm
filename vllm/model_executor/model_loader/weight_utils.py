...
def get_quant_config(
    ...
    from vllm.config.quantization import QuantizationConfigArgs, _ONLINE_SHORTHANDS
    ...
    def maybe_compose_online_quantization(
        ...
        logger.info(
            "Composing online quantization onto checkpoint method %s "
            "(linear=%s moe=%s ignore=%s)",
    ...
    # Continue below when composing onto a checkpoint method, or when the
    # shorthand is ambiguous (mxfp4 / mxfp8).
